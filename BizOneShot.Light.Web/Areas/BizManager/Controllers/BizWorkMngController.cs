...
{
    // anonymous는 어떤 누구도 접근 가능
    [UserAuthorize(Order = 1)] //로그인한 애들만
    [MenuAuthorize(Roles = UserType.BizManager, Order = 2)] // 비즈매니저 인 애들만
    public class BizWorkMngController : BaseController
    {
        ...
        //    {
        //        var scUsr = Mapper.Map<VcUsrInfo>(bizWorkViewModel);
        //        var scBizWork = Mapper.Map<VcBizWork>(bizWorkViewModel);
        ...
        //        //저장
        //        IList<VcBizWork> scBizWorks = new List<VcBizWork>();
        //        scUsr.VcBizWorks.Add(scBizWork);
        ...
        //public async Task<ActionResult> BizWorkComDetail(string bizWorkSn, string compSn)
        //{
