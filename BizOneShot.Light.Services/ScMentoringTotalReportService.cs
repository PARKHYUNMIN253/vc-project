...
namespace BizOneShot.Light.Services
{
    public interface IScMentoringTotalReportService : IBaseService
    {
        ...
        // 심화보고서 수정
        Task ModifyDeepenReportAsync(ScMentoringTotalReport scMentoringTotalReport);
    ...
    public class ScMentoringTotalReportService : IScMentoringTotalReportService
    {
        ...
        {
            return await scMentoringTotalReportRepository.GetTotalReportInfoByReportSn(totalReportSn);
        }
        ...
        public async Task<IList<ScMentoringTotalReport>> getDeepenReportListByMentorId(string mentorId)
        {
            return
                await
                    scMentoringTotalReportRepository.getDeepenReportListByMentorId(mentorId);
        }
        ...
        {
            return await scMentoringTotalReportRepository.checkRegDeepenReport(compSn, mentorId, numSn, subNumSn, conCode);
        }

        public async Task ModifyDeepenReportAsync(ScMentoringTotalReport scMentoringTotalReport)
        {
            await Task.Run(() => scMentoringTotalReportRepository.Update(scMentoringTotalReport));
        ...
        {
            return await scMentoringTotalReportRepository.getDeepenReportListByCompSn(compSn);
        }
    }
}