...
namespace BizOneShot.Light.Dao.Repositories
{
    public interface IQuesCompInfoRepository : IRepository<QuesCompInfo>
    {
        ...
        Task<QuesCompInfo> InsertToAsync(QuesCompInfo quesCompInfo);
    }
    ...
    public class QuesCompInfoRepository : RepositoryBase<QuesCompInfo>, IQuesCompInfoRepository
    {
        ...
        public async Task<QuesCompInfo> InsertToAsync(QuesCompInfo quesCompInfo)
        {
            return await Task.Run(() => DbContext.QuesCompInfoes.Add(quesCompInfo));
        }
    }
}