...
namespace BizOneShot.Light.Dao.Repositories
{
    ...
    public class ScReqDocRepository : RepositoryBase<ScReqDoc>, IScReqDocRepository
    {
        ...
        //        .Where(
        //            rd =>
        //                rd.SenderId == senderId && rd.Status == "N" && rd.VcUsrInfo_ReceiverId.UsrType == "P" &&
        //                rd.VcUsrInfo_ReceiverId.UsrTypeDetail == sendExpertType)
        ...
        //        .Where(
        //            rd =>
        //                rd.ReceiverId == receiverId && rd.Status == "N" && rd.VcUsrInfo_SenderId.UsrType == "P" &&
        //                rd.VcUsrInfo_SenderId.UsrTypeDetail == sendExpertType)
        //        .Where(rd => rd.ReqDt >= startDate && rd.ReqDt <= endDate)
        //        .OrderByDescending(rd => rd.ReqDt).ToPagedListAsync(page, pageSize);
        //}
