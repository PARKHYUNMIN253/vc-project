...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class VcIfQuesCompInfoConfiguration : EntityTypeConfiguration<VcIfQuesCompInfo>
    {
        public VcIfQuesCompInfoConfiguration()
            : this("dbo")
        {
        }
 
        public VcIfQuesCompInfoConfiguration(string schema)
        {
            ToTable(schema + ".VC_IF_QUES_COMP_INFO");
            ...
            Property(x => x.StandardCode2).HasColumnName("STANDARD_CODE2").IsOptional().IsFixedLength().IsUnicode(false).HasColumnType("char").HasMaxLength(5);
            Property(x => x.StandardCode3).HasColumnName("STANDARD_CODE3").IsOptional().IsFixedLength().IsUnicode(false).HasColumnType("char").HasMaxLength(5);
            ...
            Property(x => x.MarketForeign).HasColumnName("MARKET_FOREIGN").IsOptional().HasColumnType("bit");
            ...
            Property(x => x.ResidentEtcText).HasColumnName("RESIDENT_ETC_TEXT").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
