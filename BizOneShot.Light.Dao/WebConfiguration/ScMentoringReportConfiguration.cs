...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScMentoringReportConfiguration : EntityTypeConfiguration<ScMentoringReport>
    {
        ...
        public ScMentoringReportConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.VcCompInfo).WithMany(b => b.ScMentoringReports).HasForeignKey(c => c.CompSn); // FK_SC_COMP_INFO_TO_SC_MENTORING_REPORT
            HasOptional(a => a.VcUsrInfo).WithMany(b => b.ScMentoringReports).HasForeignKey(c => c.MentorId); // FK_SC_USR_TO_SC_MENTORING_REPORT
            InitializePartial();
        }
