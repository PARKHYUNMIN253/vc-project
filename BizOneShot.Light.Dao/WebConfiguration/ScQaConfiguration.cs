...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScQaConfiguration : EntityTypeConfiguration<ScQa>
    {
        ...
        public ScQaConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.VcUsrInfo_AnswerId).WithMany(b => b.ScQas_AnswerId).HasForeignKey(c => c.AnswerId); // FK_SC_USR_TO_SC_QA2
            HasOptional(a => a.VcUsrInfo_QuestionId).WithMany(b => b.ScQas_QuestionId).HasForeignKey(c => c.QuestionId); // FK_SC_USR_TO_SC_QA
            InitializePartial();
        }
