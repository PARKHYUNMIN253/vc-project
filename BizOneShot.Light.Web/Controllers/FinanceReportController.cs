...
namespace BizOneShot.Light.Web.Controllers
{
    ...
    public class FinanceReportController : BaseController
    {
        ...
        public FinanceReportController(IScCompMappingService _scCompMappingService, 
            IFinenceReportService _finenceReportService, IScBizWorkService _scBizWorkService, 
            IVcCompInfoService _vcCompInfoService, 
            IRptFinanceCommentService _rptFinanceCommentService)
        {
        ...
        public async Task<ActionResult> FinanceMng(FinanceMngViewModel financeMngViewModel)
        {
            ...
            // 로그인 기업의 승인된 사업정보를 가져옮
            var scCompInfo = await _vcCompInfoService.getVcCompInfoByCompSn(financeMngViewModel.CompSn);
            ViewBag.SelectYearList = ReportHelper.MakeYear(2014);
