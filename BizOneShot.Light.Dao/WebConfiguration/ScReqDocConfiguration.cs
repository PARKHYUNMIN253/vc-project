...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScReqDocConfiguration : EntityTypeConfiguration<ScReqDoc>
    {
        ...
        public ScReqDocConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.VcUsrInfo_ReceiverId).WithMany(b => b.ScReqDocs_ReceiverId).HasForeignKey(c => c.ReceiverId); // FK_SC_USR_TO_SC_REQ_DOC2
            HasRequired(a => a.VcUsrInfo_SenderId).WithMany(b => b.ScReqDocs_SenderId).HasForeignKey(c => c.SenderId); // FK_SC_USR_TO_SC_REQ_DOC
            InitializePartial();
        }
