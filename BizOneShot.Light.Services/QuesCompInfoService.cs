...
namespace BizOneShot.Light.Services
{
    public interface IQuesCompInfoService : IBaseService
    {
        ...
        // add Loy
        Task<int> AddQuesCompInfoAsyncTo(QuesCompInfo quesCompInfo);
    }
    ...
    public class QuesCompInfoService : IQuesCompInfoService
    {
        ...
        public async Task<int> AddQuesCompInfoAsyncTo(QuesCompInfo quesCompInfo)
        {
            var rstQuesCompInfo = await _quesCompInfoRepository.InsertToAsync(quesCompInfo);
