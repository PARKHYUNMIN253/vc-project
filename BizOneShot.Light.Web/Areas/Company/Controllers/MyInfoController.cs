...
namespace BizOneShot.Light.Web.Areas.Company.Controllers
{
...

    {
        ...
        public MyInfoController(IScUsrService scUsrService, IScBizTypeService scBizTypeService, IDareAcStdIncmrateBseIdstTService dareAcStdIncmrateBseIdstTService, IVcCompInfoService _vcCompInfoService)
        {
            ...
            _vcCompInfoService = _vcCompInfoService;
        }
